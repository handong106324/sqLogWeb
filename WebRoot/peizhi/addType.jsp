			...
			<section class="container">
				...
				<section class="area">
					...
					<section class="sub_area">
						...
						<form action="${basePath }/peizhi/addType">
						<table>
							<tr>
								<td>游戏名称</td>
								<td><input id="gameName" type="text" name="gameName" value="">
							</tr>
							<tr>
								<td>文件名</td>
								<td><input id="fileName" type="text" name="fileName" value="">
							</tr>
							<tr>
								<td>类型</td>
								<td><input id="type" type="text" name="type" value="">
							</tr>
							<tr>
							<td>过滤词</td>
