			...
			<section class="container">
				...
				<section class="area">
					...
					<section class="sub_area">
						...
						<p><a class="button white small-inp" href="${basePath }/role/showAddOrUpdate">新增+</a></p>
						<br>
							...
							<tbody>
								<c:forEach items="${page.list }" var="bean">
									<tr>
									      ...
									      <td>
									      	<a href="${basePath }/role/showAddOrUpdate/${bean.id}">修改</a>
									      	&nbsp;&nbsp;
									      	<a href="#" onclick="deleteBean('${bean.id}')">删除</a>
									      	&nbsp;&nbsp;
									      	<a href="${basePath}/role/showRoleResource?roleName=${bean.roleName}&roleId=${bean.id}">菜单分配</a>
